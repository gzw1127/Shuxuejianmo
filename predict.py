...
def predict(img_path):
    ...
    if device=="cpu":
        # 加载模型参数
        model.load_state_dict(torch.load("BEST_resnet_epoch_41_acc_85.9.pth",map_location=torch.device('cpu')))
    else:
        model.load_state_dict(torch.load("BEST_resnet_epoch_41_acc_85.9.pth"),False)
...
if __name__ == "__main__":
    img_path = '../display/dandelion1 (1).jpg'
